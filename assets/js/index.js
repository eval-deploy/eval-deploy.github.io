...
$(document).ready(function () {
  ...
  // populate_affiliatons('organizer-affiliation-logo-content', organizer_affiliations)

  // advisory committee content
  populate_people_html('advisory-committee-content', advisory_committee)
